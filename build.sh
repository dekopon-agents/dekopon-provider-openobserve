#!/usr/bin/env bash
# Build openobserve-provider.wasm reproducibly.
#
...
core="$target_root/wasm32-unknown-unknown/release/dekopon_openobserve_provider.wasm"
component=${1:-"$root/openobserve-provider.wasm"}
...
CARGO_ENCODED_RUSTFLAGS="$encoded_rustflags" \
  ...
  --locked --manifest-path "$manifest" --package dekopon-openobserve-provider \
